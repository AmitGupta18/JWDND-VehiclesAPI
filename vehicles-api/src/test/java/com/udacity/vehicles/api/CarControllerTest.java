...
public class CarControllerTest {
	...
	public void listCars() throws Exception {
		...
		mvc.perform(get("/cars").accept(MediaType.APPLICATION_JSON_UTF8))
				...
				.andExpect(jsonPath("_embedded.carList[0].details.body", is(equalTo(car.getDetails().getBody()))));
	}
	...
	public void findCar() throws Exception {
		...
		mvc.perform(get("/cars/1").accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isOk())
				.andExpect(jsonPath("id", is(1))).andExpect(jsonPath("details.body", is(car.getDetails().getBody())));
	}
	...
	public void deleteCar() throws Exception {
		mvc.perform(delete("/cars/1").accept(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isNoContent());
	}
